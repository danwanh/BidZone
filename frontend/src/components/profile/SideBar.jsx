    ...
    <div className="h-fit text-[15px]">
      ...
      <form className="info" onSubmit={handleSubmitPersonalInfo(onSubmitPersonalInfo)}>
        ...
        <div className="main_info_wrapper">
          ...
          {isEditing ? (
            <input {...registerPersonalInfo("fullname")} type="text" placeholder={user.name} className="input_style" />
          ) : (
            <p className="text-[#171a22] py-2">{user.name || "Chưa cập nhật"}</p>
          )}
        </div>
        ...
        <div className="main_info_wrapper">
          ...
          {isEditing ? (
            ...
            <p className="text-[#171a22] py-2">{user.username || "Chưa cập nhật"}</p>
          )}
        </div>
        ...
        <div className="flex flex-col gap-2 xl:flex-row justify-between w-fill">
          <div className="main_info_wrapper">
            ...
            {isEditing ? (
              ...
              <p className="text-[#171a22] py-2">{user.phone || "Chưa cập nhật"}</p>
            )}
          </div>
          ...
          <div className="main_info_wrapper max-w-fit">
            ...
            {isEditing ? (
              ...
              <p className="text-[#171a22] py-2">{user.gender || "Chưa cập nhật"}</p>
            )}
          </div>
        </div>
        ...
        <div className="main_info_wrapper">
          ...
          {isEditing ? (
            <input {...registerPersonalInfo("email")} type="email" placeholder={user.email} className="input_style" />
          ) : (
            <p className="text-[#171a22] py-2">{user.email || "Chưa cập nhật"}</p>
          )}
        </div>
        ...
        <div className="main_info_wrapper">
          <p className="info_header cursor-pointer hover:text-blue-700 w-fit" onClick={() => setShowPopUp(true)}>
            ĐỔI MẬT KHẨU?
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          {user.role === "bidder" && (
            <button className="button bg-green-600 hover:bg-green-700" type="button" onClick={handleBecomeSeller}>
              <div className="font-bold text-white">Muốn trở thành người bán</div>
            </button>
          )}
        </div>
      </form>
