...
const SideBar = ({ user, isOwnProfile }) => {
  ...
  if (user && userData.is_deleted) {
    return (
      <div className="info">
        <p className="text-gray-500 text-center py-4">Tài khoản này đã bị xóa.</p>
      </div>
    )
  }
  ...
  if (isComment) {
    return (
      <div className="info h-full flex flex-col min-h-[600px]">
              ...
              >
                ...
                <div className="flex justify-between items-start mb-3">
                  ...
                  ${
                    ...
                    {/* Name & Role */}
                    <div>
                      <h4 className="font-bold text-gray-800 text-sm leading-tight">{userName}</h4>
    ...
    return (
      <div className="h-full text-[15px] h-[600px]">
        ...
        {showPopUp && (
          ...
          >
            ...
            >
              ...
              <form className="flex flex-col gap-5" onSubmit={handleSubmitPassword(onSubmitPassword)}>
                <div className="main_info_wrapper">
                  <div className="info_header">MẬT KHẨU CŨ</div>
                  <input type="password" {...registerPassword("oldPassword")} className="input_style" />
                </div>
                ...
                <div className="main_info_wrapper">
                  ...
                  <input type="password" {...registerPassword("newPassword")} className="input_style" />
                </div>
        ...
        {/* ---------- MAIN FORM ---------- */}
        <form
          className="info h-full flex flex-col justify-between"
        ...
        >
          <div className="space-y-4 flex-1">
            ...
            <div className="pb-2 border-b border-gray-100">
              <p className="text-[#171a22] font-bold text-xl mb-2">{userData.name}</p>
              <div className="flex gap-5 flex-col md:flex-row">
                <div className="flex gap-2 items-center">
                  ...
                  <p className="text-[#667eea] font-bold">{userData.rating_pos}</p>
                </div>
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <p className="text-[#667eea] font-bold">{userData.rating_neg}</p>
                </div>
                {!isEditing && (
                  <button
            ...
            <div className="main_info_wrapper">
              ...
              {isEditing ? (
                ...
                <p className="other_users_text">{userData.name || "Chưa cập nhật"}</p>
              )}
            </div>
            ...
            <div className="main_info_wrapper">
              ...
              {isEditing ? (
                ...
                <p className="other_users_text">{userData.username || "Chưa cập nhật"}</p>
              )}
            </div>

            <div className="flex flex-col gap-4 xl:flex-row justify-between w-full">
              <div className="main_info_wrapper flex-1">
                ...
                {isEditing ? (
                  ...
                  <p className="other_users_text">{userData.phone || "Chưa cập nhật"}</p>
                )}
              </div>

              <div className="main_info_wrapper w-full xl:w-1/3">
                <div className="info_header">GIỚI TÍNH</div>
                {isEditing ? (
                  <select {...registerPersonalInfo("gender")} className="input_style">
                    <option value="">Nam</option>
                    <option>Nữ</option>
                    <option>Khác</option>
                  </select>
                ) : (
                  <p className="other_users_text">{userData.gender || "Chưa cập nhật"}</p>
                )}
              </div>
            </div>
            ...
            <div className="main_info_wrapper">
              ...
              {isEditing ? (
                ...
                <p className="other_users_text whitespace-normal break-all">{userData.email || "Chưa cập nhật"}</p>
              )}
            </div>
            ...
            {isOwnProfile && (
              <div className="main_info_wrapper">
                <p
                  className="info_header cursor-pointer hover:text-blue-700 w-fit inline-flex items-center gap-1"
              ...
              <>
                {isEditing ? (
                  <div className="flex gap-3 md:flex-row flex-col">
                    <button
                      className="bg-[#667EEA] text-white rounded-lg py-2.5 px-4 flex-1 font-bold hover:bg-[#4961d0] transition-colors shadow-sm"
                      type="submit"
                    >
                      Lưu thay đổi
                    </button>
                    <button
                      className="bg-gray-100 text-gray-700 rounded-lg py-2.5 px-4 flex-1 font-bold hover:bg-gray-200 transition-colors"
                      type="button"
                  ...
                  <button
                    className="bg-[#667EEA] text-white rounded-lg py-2.5 px-4 w-full font-bold hover:bg-[#4961d0] transition-colors shadow-sm"
                    type="button"
