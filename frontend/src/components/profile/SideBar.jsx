...
const SideBar = ({ user, isOwnProfile }) => {
            ...
            >
              ...
              <form className="flex flex-col gap-5" onSubmit={handleSubmitPassword(onSubmitPassword)}>
                <div className="w-full h-fit flex flex-col justify-center gap-[5px]">
                  <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">MẬT KHẨU CŨ</div>
                  <input
                    type="password"
  ...
  outline-none"
                ...
                <Link to="/auth" state={{ page: "FORGETPASS" }} type="button" className="text-[#a2a2a2] mt-[-14px]">
                  Quên mật khẩu?
                </Link>
                <div className="w-full h-fit flex flex-col justify-center gap-[5px]">
                  <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">MẬT KHẨU MỚI</div>
                  <input
                    type="password"
        ...
        >
          <div className="space-y-4 flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              <div className="text-[#171a22] font-bold text-[26px]">Thông tin cá nhân</div>
            </div>
            ...
            <div className="w-full h-fit flex flex-col justify-center gap-[5px]">
              <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">HỌ TÊN</div>
              {isEditing ? (
                <input
  ...
  outline-none"
                ...
                <p className="text-[#282e40] text-[18px] font-semibold">{userData.name || "Chưa cập nhật"}</p>
              )}
            </div>

            <div className="w-full h-fit flex flex-col justify-center gap-[5px]">
              <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">TÊN TÀI KHOẢN</div>
              {isEditing ? (
                <input
  ...
  outline-none"
                ...
                <p className="text-[#282e40] text-[18px] font-semibold">{userData.username || "Chưa cập nhật"}</p>
              )}
            </div>
            ...
            <div className="flex flex-col gap-4 xl:flex-row justify-between w-full">
              <div className="w-full h-fit flex flex-col justify-center gap-[5px] flex-1">
                <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">SỐ ĐIỆN THOẠI</div>
                {isEditing ? (
                  <input
  ...
  outline-none"
                  ...
                  <p className="text-[#282e40] text-[18px] font-semibold">{userData.phone || "Chưa cập nhật"}</p>
                )}
              </div>

              <div className="w-full h-fit flex flex-col justify-center gap-[5px] w-full xl:w-1/3">
                <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">GIỚI TÍNH</div>
                {isEditing ? (
                  <select
  ...
  outline-none"
                  ...
                  <p className="text-[#282e40] text-[18px] font-semibold">{userData.gender || "Chưa cập nhật"}</p>
                )}
              </div>
            </div>

            <div className="w-full h-fit flex flex-col justify-center gap-[5px]">
              <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">ĐỊA CHỈ EMAIL</div>
              {isEditing ? (
                <input
  ...
  outline-none"
            ...
            <div className="w-full h-fit flex flex-col justify-center gap-[5px]">
              <div className="text-[#666666] font-bold text-[13px] tracking-[0.5px]">NGÀY SINH</div>
              {isEditing ? (
                <input
