        ...
        <div className="h-fit text-[15px]">
                    ...
                    >
                        ...
                        <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="flex justify-between px-5 w-full">
                                <button 
                                    type="submit" 
                                    className="cursor-pointer bg-blue-600 text-white px-4 py-2 rounded-[10rem] w-1/3"
                                >
                                    CẬP NHẬT
                                </button>
                                ...
                                <button 
                                    ...
                                    className="cursor-pointer border px-4 py-2 rounded-[10rem] w-1/3"
                                >
                                    KHÔNG
                                </button>
                            </div>
            ...
            <form className="info" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="main_info_wrapper">
                    ...
                    <input {...register("fullname")} type="text" placeholder="Jon" className="input_style" />
                </div>

                <div className="main_info_wrapper">
                    <div className="info_header">TÊN TÀI KHOẢN</div>
                    <input {...register("username")} type="text" placeholder="Jon" className="input_style" />
                </div>

                <div className="flex flex-col lg:flex-row justify-between w-fill">
                    <div className="main_info_wrapper">
                        <div className="info_header">SỐ ĐIỆN THOẠI</div>
                        <input {...register("phonenumber")} type="text" placeholder="09999" className="input_style" />
                    </div>
                ...
                <div className="main_info_wrapper">
                    ...
                    <input {...register("email")} type="email" placeholder="Jon@email" className="input_style" />
                </div>
