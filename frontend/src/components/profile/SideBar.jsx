  ...
  if (isComment) {
    return (
      <div className="info">
        ...
        <div
          className="max-h-148 overflow-y-scroll flex flex-col gap-2 [&::-webkit-scrollbar]:w-1.5
        ...
        <button
          ...
          className="text-sm bg-[#667EEA] text-white px-2 py-2 rounded-lg w-fit cursor-pointer hover:bg-[#4961d0] mx-auto"
        >
              ...
              <>
                {isEditing ? (
                  <div className="flex gap-3">
                    ...
                    <button
                      className="button_huy bg-gray-400 hover:bg-gray-500 flex-1"
                      type="button"
                      onClick={() => setIsEditing(false)}
                    >
                      <div className="font-bold text-[#6a23c6] z-1">Hủy</div>
                    </button>
                  </div>
                ) : (
                  <button
