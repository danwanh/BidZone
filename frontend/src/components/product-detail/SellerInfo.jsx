            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-2">
                <span className="text-sm text-green-600">
                  {seller.rating_pos} / {seller.rating_neg + seller.rating_pos}{" "}
                  đánh giá tích cực
                </span>
              </div>
              <Link
                to={`/profile?tab=Đang+đấu+giá&page=1&id=${seller._id}`}
      ...
      <div className="md:col-span-2 bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl shadow-lg border-2 border-green-300">
        ...
        {highestBidder ? (
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm text-green-600 font-semibold">
                  {highestBidder.rating_pos} / {highestBidder.reviews} đánh giá
                  tích cực
                </span>
              </div>
              {/* <button
          ...
          <div className="text-gray-600 text-center">
            Chưa có người đặt giá nào cho sản phẩm này.
          </div>
        )}
      </div>
    </div>
