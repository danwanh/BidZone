...
export default function UploadProductPage() {
  ...
  const handleImageUpload = async (e) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      try {
        const response = await fetch(`https://api.cloudinary.com/v1_1/dc0eacbib/image/upload`, {
          method: "POST",
          body: formData,
        })
        const data = await response.json()
  ...
  return (
  <div className="min-h-screen min-w-7xl flex items-center justify-center bg-gray-50 p-6">
      <div className="max-w-4xl min-w-7xl mx-auto">
        <button
          onClick={() => window.history.back()}
          className="mb-6 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition"
        >
          ← Quay lại
        </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label htmlFor="images" className="block text-sm font-medium text-gray-700">
                  Hình ảnh sản phẩm (tối thiểu 3 ảnh) <span className="text-red-500">*</span>
                </label>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label htmlFor="bid_step" className="block text-sm font-medium text-gray-700">
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, bid_step: e.target.value })}
              ...
              <div className="space-y-2">
                <label htmlFor="buy_now_price" className="block text-sm font-medium text-gray-700">
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-3 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, is_autobid: e.target.checked })}
                      className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                    />
                    <div>
                      <span className="text-sm font-medium text-gray-700">Cho phép đấu giá tự động</span>
                      <p className="text-xs text-gray-500">
                        Người mua có thể đặt giá tối đa và hệ thống tự động đấu giá
                      </p>
                    </div>
                  </label>
                </div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-3 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, allow_unrated_bidders: e.target.checked })}
                      className="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                    />
                    <div>
